...
func TestM4DApplicationControllerCSVCopyAndRead(t *testing.T) {
	...
	dummySecret.Namespace = getControllerNamespace()
	...
	account.Namespace = getControllerNamespace()
...
func TestCopyData(t *testing.T) {
	...
	secret1.Namespace = getControllerNamespace()
	...
	account1.Namespace = getControllerNamespace()
	...
	secret2.Namespace = getControllerNamespace()
	...
	account2.Namespace = getControllerNamespace()
